...
import { 
  ...
  Loader2, Filter, Bell, Navigation
} from 'lucide-react';
        ...
        <aside className="w-96 flex flex-col gap-6">
          <header className="flex items-center justify-between">
            <div className="space-y-1">
              <h2 className="text-2xl font-headline font-bold text-white tracking-tight">Live SITREPs</h2>
            ...
            <div className="flex gap-2">
              <Button variant="outline" size="icon" className="liquid-glass border-white/5 h-8 w-8 text-white/40"><Filter className="w-4 h-4" /></Button>
              <Button variant="outline" size="icon" className="liquid-glass border-white/5 h-8 w-8 text-white/40 relative">
            ...
            <div className="flex-1 flex flex-col p-10 relative z-10">
              <header className="flex items-start justify-between mb-12">
                <div className="space-y-4">
                  ...
                  <h1 className="text-4xl font-headline font-bold text-white tracking-tighter leading-tight max-w-2xl">
                ...
                <div className="flex gap-3">
                  <Button 
                    variant="outline" 
                    className="liquid-glass border-white/5 text-white/60 font-bold rounded-2xl h-12 px-6 gap-2"
                  ...
                  <Button 
                    variant="outline" 
                    className="bg-green-500/20 border-green-500/30 text-green-500 font-bold rounded-2xl h-12 px-6 gap-2"
                ...
                <div className="col-span-2 space-y-8">
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <IntelligenceCard 
                      ...
                      label="GPS Lock" 
                      value={`${selectedReport.lat.toFixed(4)}, ${selectedReport.lng.toFixed(4)}`} 
                      desc="Precise coordinates"
                    />
                    <IntelligenceCard 
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 text-[7px] text-white/40 font-bold uppercase tracking-widest">
        ...
        <span className="flex items-center gap-1"><Navigation className="w-2.5 h-2.5" /> GPS Locked</span>
      </div>
    </div>
  );
}
    ...
    <div className="liquid-glass p-6 rounded-3xl border-white/5 space-y-3 hover:border-white/10 transition-all group">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-base font-headline font-bold text-white tracking-tight truncate">{value}</p>
        </div>
      </div>
